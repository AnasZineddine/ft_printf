...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/05 15:41:24 by azineddi          #+#    #+#             */
/*   Updated: 2019/10/25 17:23:52 by azineddi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_flags_one_charachter_d(intmax_t n, t_format *strc, t_var *var_d)
{
	if (strc->precision == -1)
	{
		strc->precision = 0;
