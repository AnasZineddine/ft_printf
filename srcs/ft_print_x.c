...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/16 16:39:46 by azineddi          #+#    #+#             */
/*   Updated: 2019/10/25 16:44:49 by azineddi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_flags_one_charachter_x(uintmax_t n, t_format *strc, t_var *var_d)
{
	if (strc->precision == -1)
		strc->precision = 0;
